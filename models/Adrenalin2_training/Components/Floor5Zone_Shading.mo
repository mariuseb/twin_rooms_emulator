...
parameter Buildings.HeatTransfer.Data.Solids.GypsumBoard matGyp2(
  ...
  InternalGains.InternalGains                           gai(
    ...
    Modelica.Blocks.Sources.RealExpression CO2Gen220(y=0)
  ...
  Modelica.Blocks.Sources.RealExpression CO2Gen219(y=0)
...
equation
  ...
  connect(intGains2nd.y, room220.qGai_flow) annotation (Line(points={{-103,22},
          {-92,22},{-92,-18},{18.4,-18}}, color={0,0,127}));
  connect(intGains2nd.y, room219.qGai_flow) annotation (Line(points={{-103,22},
          {130,22},{130,-16},{140.4,-16}}, color={0,0,127}));
